...
class TiingoClient:
    ...
    async def test_connection(self) -> bool:
        """
        Test the connection to Tiingo API.
        
        Returns:
            True if connection is successful
        """
        try:
            # Test with a simple metadata request for Apple
            ticker_info = await self.get_ticker_metadata("AAPL")
...
async def get_tiingo_client() -> TiingoClient:
    """Get a Tiingo client instance."""
    return TiingoClient() 